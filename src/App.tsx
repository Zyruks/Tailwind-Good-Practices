  ...
  const games: VideoGame[] = [
    {
      ...
      description: 'Immerse yourself in a dystopian future where choices shape your destiny',
    ...
    },
    {
      ...
      description: 'Explore vast kingdoms and battle mythical creatures in this epic journey',
    ...
    },
    {
      ...
      description: 'Command your fleet and conquer the galaxy in this strategic space warfare',
    ...
    },
    {
      ...
      description: 'Experience ultimate racing thrills with next-gen graphics and physics',
    ...
    },
    {
      ...
      subtitle: 'Action RPG',
      description: 'Track and hunt magnificent creatures in a breathtaking open world',
      image: 'https://images.unsplash.com/photo-1552820728-8b83bb6b773f',
    },
  ];

  return (
    <GridLayout title="Featured Games" items={games} renderItem={(game) => <GameCard key={game.id} {...game} />} />
  );
}
